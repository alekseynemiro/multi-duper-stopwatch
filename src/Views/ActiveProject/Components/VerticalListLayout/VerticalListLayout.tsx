...
import { VerticalListLayoutProps } from "./VerticalListLayoutProps";
import { activityStyles, addActivityStyles, verticalListLayoutStyles } from "./VerticalListLayoutStyles";
...
export function VerticalListLayout(props:VerticalListLayoutProps): JSX.Element {
  ...
  return (
    ...
    >
      <View
        style={verticalListLayoutStyles.container}
      >
        {
          activities?.map(
